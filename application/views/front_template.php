        ...
        <div class="container-fluid zero-padding">
          ...
          <div id="navbar" class="navbar-collapse collapse zero-padding">
            <ul class="nav navbar-nav pull-left">
              ...
              <li class="dropdown"> <a href="#" class="dropdown-toggle hvr-sweep-to-bottom padd" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="right-arrow"><img src="<?php echo base_url();?>images/frontend/View.png" /></span>View <span class="caret"></span></a>
                <ul class="dropdown-menu">
                  <li><a href="#">Action</a></li>
                  <li><a href="#">Another action</a></li>
                  <li><a href="#">Something else here</a></li>
              ...
              <li class="dropdown">
                ...
                <span class="right-arrow"><img src="<?php echo base_url();?>images/frontend/fauvrates.png" /></span>Fauvrates <span class="caret"></span></a>
                <ul class="dropdown-menu">
                  <li><a href="#">Action</a></li>
                  <li><a href="#">Another action</a></li>
                  <li><a href="#">Something else here</a></li>
              ...
              <li class="dropdown">
                <a href="#" class="dropdown-toggle hvr-sweep-to-bottom padd" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                <span class="right-arrow"><img src="<?php echo base_url();?>images/frontend/FOLDER-search.png" /></span>Search <span class="caret"></span></a>
                <ul class="dropdown-menu">
                  <li><a href="#">Action</a></li>
                  <li><a href="#">Another action</a></li>
                  <li><a href="#">Something else here</a></li>
